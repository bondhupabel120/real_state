...
<link rel="stylesheet" href="{{ theme_asset('jomidar/public/assets/css/owl.carousel.min.css') }}">
<link rel="stylesheet" href="{{ theme_asset('jomidar/public/assets/css/magnific-popup.css') }}">
@endpush

@section('content')
 <!-- Slider -->
 <div class="fullwidth-property-slider margin-bottom-65">
	<a href="{{ $property->post_preview->media->url ?? asset('uploads/default.png') }}" data-background-image="{{ $property->post_preview->media->url ?? asset('uploads/default.png') }}" class="item mfp-gallery"></a>
	    ...
	    <!-- Titlebar -->
		  <div id="titlebar-dtl-item" class="property-titlebar margin-bottom-0">
			  <div class="property-title">
				<div class="property-pricing">{{ amount_format($property->min_price->price ?? 0) }} - {{ amount_format($property->max_price->price ?? 0) }}/mo</div>
				<h2>{{ $property->title }} <span class="property-badge-sale">For Sale</span></h2>
				<span class="utf-listing-address"><i class="icon-material-outline-location-on"></i> 2021 San Pedro, BD 90015</span>
          ...
          <ul class="property-features margin-top-0">
            <li>Property ID: <span>HP1714</span></li>
            <li>Price: <span>$180,000</span></li>
            <li>Property Size: <span>1480 Sq Ft</span></li>
          ...
          <!-- Floorplans -->
		  <div class="utf-desc-headline-item">
			<h3><i class="icon-line-awesome-paper-plane"></i> Property Floor Plans</h3>
		  </div>
          <!-- Accordion -->
          <div class="style-1 fp-accordion">
            <div class="accordion">
              <h3>First Floor <span>Size: <strong>1280 Sqft</strong></span> <span>Rooms: <strong>650 Sqft</strong></span> <span>Baths: <strong>500 Sqft</strong></span> <span>Price: <strong>$15,000</strong></span> <i class="sl sl-icon-plus"></i> </h3>
              <div>
			    <a class="floor-pic mfp-image" href="images/floor_plan_1.jpg"> <img src="images/floor_plan_1.jpg" alt=""> </a>
              ...
              <h3>Second Floor <span>Size: <strong>1280 Sqft</strong></span> <span>Rooms: <strong>650 Sqft</strong></span> <span>Baths: <strong>500 Sqft</strong></span> <span>Price: <strong>$15,000</strong></span> <i class="sl sl-icon-plus"></i></h3>
              <div>
			    <a class="floor-pic mfp-image" href="images/floor_plan_2.jpg"> <img src="images/floor_plan_2.jpg" alt=""> </a>
                <p>Plan description. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
              </div>
            </div>
          </div>
          ...
          <div class="responsive-iframe">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/oqNZOOWF8qM" allowfullscreen></iframe>
          </div>
          ...
          <div class="utf-desc-headline-item">
			<h3><i class="icon-material-outline-description"></i> Similar Property</h3>
		  </div>
          ...
          <div class="utf-listings-container-area list-layout">
            ...
            <div class="utf-listing-item"> <a href="#" class="utf-smt-listing-img-container">
              ...
              <img src="images/listing-04.jpg" alt=""> </a>
              <div class="utf-listing-content">
                <div class="utf-listing-title">
				  <span class="utf-listing-price">$18,000/mo</span>
                  <h4><a href="#">Renovated Luxury Apartment</a></h4>
		  ...
		  <!-- Reviews -->
          <section class="comments margin-top-40">
			<div class="utf-inner-blog-section-title">
				<h4><i class="icon-line-awesome-commenting-o"></i> Comments (5)</h4>
			</div>
            <ul>
              <li>
                <div class="avatar"><img src="images/coumment-user-1.jpg" alt="" /></div>
                <div class="comment-content">
                  <div class="arrow-comment"></div>
                  <div class="comment-by">Mohsin Sheikh<span class="date">10 OCT 2021</span> <a href="#" class="reply"><i class="fa fa-reply"></i> Reply</a> </div>
                ...
                <ul>
                  <li>
                    <div class="avatar"><img src="images/coumment-user-2.jpg" alt="" /></div>
                    <div class="comment-content">
                      <div class="arrow-comment"></div>
                      <div class="comment-by">Mohsin Sheikh<span class="date">10 OCT 2021</span> <a href="#" class="reply"><i class="fa fa-reply"></i> Reply</a> </div>
                      <p>Lorem Ipsum is simply dummy text of printing and type setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
              ...
              <li>
                <div class="avatar"><img src="images/coumment-user-3.jpg" alt="" /> </div>
                <div class="comment-content">
                  <div class="arrow-comment"></div>
                  <div class="comment-by">Mohsin Sheikh<span class="date">10 OCT 2021</span> <a href="#" class="reply"><i class="fa fa-reply"></i> Reply</a> </div>
                  <p>Lorem Ipsum is simply dummy text of printing and type setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
          ...
          <div class="widget utf-sidebar-widget-item">
            <div class="agent-widget">
              ...
              <div class="agent-title">
                <div class="agent-photo"><img src="{{ $property->user->avatar ?? null }}" alt="" /></div>
                <div class="agent-details">
                  <h4><a href="#">{{ $property->name }}</a></h4>
                  <span>{{ $info->phone }}</span>
				  <span>{{ $property->user->email }}</span>
				  <span><a href="{{ route('agent.show',$property->user->slug) }}">View My Listing</a></span>
				</div>
                <div class="clearfix"></div>
              </div>
              ...
              <ul class="widget-tabs">
                ...
                <li>
                  <div class="widget-content">
                    ...
                    <div class="widget-text">
                      <h5><a href="#">How to “Woo” a Recruiter and Land Your Dream Job.</a></h5>
                      <span>$22,000/mo</span>
					</div>
                    <div class="clearfix"></div>
                  </div>
                ...
                <li>
                  <div class="widget-content">
                    ...
                    <div class="widget-text">
                      <h5><a href="#">Hey Job Seeker, It’s Time To Get Up And Get Hired.</a></h5>
                      <span>$18,000/mo</span>
					</div>
                    <div class="clearfix"></div>
                  </div>
                ...
                <li>
                  <div class="widget-content">
                    ...
                    <div class="widget-text">
                      <h5><a href="#">The Best Canadian Merchant Account Providers.</a></h5>
                      <span>$15,000/mo</span>
					</div>
                    <div class="clearfix"></div>
                  </div>
...
<script src="{{ theme_asset('jomidar/public/assets/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ theme_asset('jomidar/public/assets/js/owl.carousel.min.js') }}"></script>
<script src="{{ theme_asset('jomidar/public/assets/js/jQuery.print.js') }}"></script>
<script src="{{ theme_asset('jomidar/public/assets/js/property.js') }}"></script>
<script src="{{ theme_asset('jomidar/public/assets/js/custommap.js') }}"></script>
