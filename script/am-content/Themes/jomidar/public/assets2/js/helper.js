		...
		$(target).append(
            '<div class="utf-carousel-item-area">' +
				'<div class="utf-listing-item">' +
					'<a href="'+asset_url+'property/'+value.slug+'" class="utf-smt-listing-img-container">' +
						'<div class="utf-listing-badges-item">' +
							'<span class="featured">Featured</span>' +
							'<span class="for-sale">For Sale</span>' +
						'</div>' +
						'<div class="utf-listing-img-content-item">' +
							'<img class="utf-user-picture" src="'+ image +'" alt="user_1" />' +
					...
					'<div class="utf-listing-content">' +
						'<div class="utf-listing-title">' +
							'<span class="utf-listing-price">BDT - '+amount_format(value.min_price.price)+' - '+amount_format(value.max_price.price)+'/mo</span>' +
							'<h4><a href="'+asset_url+'property/'+value.slug+'">'+ title +'</a>' +
							'</h4>' +
							'<span class="utf-listing-address"><i class="icon-material-outline-location-on"></i> '+ location +' </span>' +
						'</div>' +
						...
						'</ul>' +
						'<div class="utf-listing-user-info"><a href="'+asset_url+'agent/'+value.user.slug+'/show'+'">' +
                            '<i class="icon-line-awesome-user"></i> '+value.user.name+'</a> <span>1 Days Ago</span>' +
                        '</div>' +
					'</div>' +
				'</div>' +
			'</div>'
		...
		$.each(value.featured_option, function(i,v){
            ...
            '<div class="utf-listing-item compact">' +
			    '<a href="single-property-page-2.html" class="utf-smt-listing-img-container">' +
				  ...
				  '<div class="utf-listing-img-content-item">' +
					 '<span class="utf-listing-compact-title-item"> '+ name +' <i>$18,000/mo</i></span>' +
				  '</div>' +
